                            ...
                            <div class="content">
                                <div class="container-fluid">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" onclick="sortemployee()" class="btn btn-info btn-fill pull-left" >Sort</button>
                                    ...
                                    while($allocation=$results->fetch_assoc())
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>    
                                             ...
                                             <button type="button" onclick="changeemployee(<?php echo $emp_id; ?>)">Change</button></td>
